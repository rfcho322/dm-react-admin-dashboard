            ...
            <div className="relative flex flex-col bg-card gap-2 col-span-3 sm:col-span-2 shadow-lg rounded-xl px-5 py-5">
              ...
              <div className="flex flex-wrap items-center gap-5">
                ...
                <div className="flex flex-col flex-wrap gap-2 p-2">
                  <h2 className="text-lg text-card-foreground/100 font-bold">Regina Phalange</h2>
                  {/* DETAIL 1 */}
                  <div className="text-sm">
                    <span className="font-bold text-card-foreground/100 mr-1">Email:</span>
                    <span>reginaphalange@gmail.com</span>
                  </div>
                  {/* DETAIL 2 */}
                  <div className="text-sm">
                    <span className="font-bold text-card-foreground/100 mr-1">Contact:</span>
                    <span>+123-456-789</span>
                  </div>
                  {/* DETAIL 3 */}
                  <div className="text-sm">
                    <span className="font-bold text-card-foreground/100 mr-1">Address:</span>
                    <span>90 Bedford Street, Greenwich Village, New York City</span>
                  </div>
                  {/* DETAIL 4 */}
                  <div className="text-sm">
                    <span className="font-bold text-card-foreground/100 mr-1">Country:</span>
                    <span>USA</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-5">
                ...
                <div className="flex col-span-4 lg:col-span-2 justify-between bg-card rounded-xl shadow-lg p-5">
                  <div className="flex flex-col gap-4 w-full">
                    ...
                    <div>
                      <h6 className="text-card-foreground">Revenue</h6>
                      <h3 className="text-card-foreground/100 text-2xl">$42,389</h3>
                    </div>
                ...
                <div className="flex col-span-4 lg:col-span-2 justify-between bg-card rounded-xl shadow-lg px-5 pt-5">
                  <div className="flex flex-col">
                    <h6 className="text-card-foreground text-lg">Profit</h6>
                    <h3 className="text-card-foreground/100 text-2xl">630k</h3>
                ...
                <div className="flex col-span-4 lg:col-span-2 justify-between bg-card rounded-xl shadow-lg p-5">
                  <div className="flex flex-col gap-4 w-full">
                    ...
                    <div>
                      <h6 className="text-card-foreground">Transactions</h6>
                      <h3 className="text-card-foreground/100 text-2xl">$14,597</h3>
                    </div>
                    <div className="flex items-center">
                      <ArrowUp className="w-4 h-4 text-green-400" />
                ...
                <div className="flex col-span-4 lg:col-span-2 justify-between bg-card rounded-xl shadow-lg p-5">
                  <div className="flex flex-col gap-2">
                    <div>
                      <h6 className="text-card-foreground">Sales</h6>
                      <h3 className="text-card-foreground/100 text-2xl">482k</h3>
                    </div>
                    <span className="w-fit text-xs font-bold rounded-sm px-2 py-1 bg-sky-100 text-cyan-400">+34%</span>
                    <div>
                      <small className="text-card-foreground/100 text-sm">Sales Target</small>
                      <div className="flex items-center gap-2">
                        <Progress value={78} indicatorColor="bg-cyan-400" className="w-28 h-3 bg-gray-100" />
                        <span className="text-card-foreground/100">78%</span>
                      </div>
                    </div>
                  </div>
                </div>
